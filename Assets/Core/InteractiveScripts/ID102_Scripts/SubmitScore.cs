namespace FilipinoTek.Grade2.ID102
{
        ...
        void Start()
        {
            ...
            submissionDate = System.DateTime.Now.ToString("MM'/'dd'/'yyyy' 'HH':'mm':'ss tt");
    #if UNITY_EDITOR
                URL = LMSv2BaseURL+ "/Student/"+"0"+"/class/"+"0"+"/interactive/"+gameNamespace+"/score";
                authKey = "Test";    
    #elif UNITY_WEBGL
                ...
                if(parameters==null || parameters == ""){
                    ...
                    classID = lessonData[1].Replace("cid=", "");

                    authKey = parametersData[1];
                    URL = LMSv2BaseURL+ "/Student/"+studentID+"/class/"+classID+"/interactive/"+gameNamespace+"/score";
                }
    #endif
        }
