...
namespace EnglishTek.Grade1.ID313
{
    public static class GameManager 
    {
        ...
        public static void GenerateItem()
        {
            ...
            foreach (XmlNode node in xmlDoc.SelectNodes(NODE))
            {
                foreach (XmlNode innerNode in node.ChildNodes)
                {
                    ...
                    if (innerNode.Name == "Correct" || innerNode.Name == "Answer") Corrects.Add(innerNode.InnerText);
                    if (innerNode.Name == "Wrong" || innerNode.Name == "Wrong1") Wrongs.Add(innerNode.InnerText);
                }
            }
        }
        ...
        {
            bool correct = false;
            correct = (Correct.ToLower() == answer.ToLower()) ? true : false;
            return correct;
        }
